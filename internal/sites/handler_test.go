...
type stubService struct {
	...
	list   func(context.Context, ListFilter) ([]Site, error)
	get    func(context.Context, uuid.UUID) (*Site, error)
	add    func(context.Context, AddInput) (*Site, error)
	toggle func(context.Context, uuid.UUID) (*Site, error)
...
func (s *stubService) List(ctx context.Context, f ListFilter) ([]Site, error) {
	if s.list == nil {
		return nil, nil
	}
	return s.list(ctx, f)
...
func (s *stubService) Get(ctx context.Context, id uuid.UUID) (*Site, error) {
	if s.get == nil {
...
func (s *stubService) Add(ctx context.Context, in AddInput) (*Site, error) {
	if s.add == nil {
		return nil, ErrNotFound
	}
	return s.add(ctx, in)
...
func (s *stubService) ToggleActive(ctx context.Context, id uuid.UUID) (*Site, error) {
	if s.toggle == nil {
		return nil, ErrNotFound
	}
	return s.toggle(ctx, id)
}
...
func TestListSitesReturnsEverySite(t *testing.T) {
	svc := &stubService{
		list: func(_ context.Context, _ ListFilter) ([]Site, error) {
			return []Site{
...
func TestListSitesPassesActiveFilter(t *testing.T) {
	var got ListFilter
	svc := &stubService{
		list: func(_ context.Context, f ListFilter) ([]Site, error) {
			got = f
			return nil, nil
		},
	}
...
func TestAddSiteCreated(t *testing.T) {
	var got AddInput
	svc := &stubService{
		add: func(_ context.Context, in AddInput) (*Site, error) {
			got = in
	...
	for _, tt := range tests {
		t.Run(
			tt.name, func(t *testing.T) {
				svc := &stubService{
					add: func(_ context.Context, _ AddInput) (*Site, error) { return nil, tt.err },
				}
...
func TestToggleSite(t *testing.T) {
	...
	var got uuid.UUID
	svc := &stubService{
		toggle: func(_ context.Context, id uuid.UUID) (*Site, error) {
			got = id
			flipped := seed
...
func TestToggleSiteNotFound(t *testing.T) {
	svc := &stubService{
		toggle: func(_ context.Context, _ uuid.UUID) (*Site, error) { return nil, ErrNotFound },
	}
...
func TestDeleteSiteNoContent(t *testing.T) {
	svc := &stubService{del: func(_ context.Context, _ uuid.UUID) error { return nil }}
...
func TestDeleteSiteMapsServiceErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(
			tt.name, func(t *testing.T) {
				svc := &stubService{del: func(_ context.Context, _ uuid.UUID) error { return tt.err }}
				rec := do(t, svc, http.MethodDelete, "/sites/"+uuid.New().String(), "")
				assertStatus(t, rec, tt.status)
				assertErrorCode(t, rec, tt.wantCode)
			},
